...
class PostIg:
    ...
    def build_post_fol(shortcode: str) -> Path:
        ...
        return get_recipamatic_paths().ig_fol / "posts" / f"{shortcode}"

    def build_paths(self) -> None:
        """Build useful post paths."""
        # FIXME should not be saved in the json file
...
class ProfileIg:
    ...
    def build_profile_fol(username: str) -> Path:
        ...
        return get_recipamatic_paths().ig_fol / "profiles" / f"{username}"
